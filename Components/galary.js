...
const heroContent = {
    title: "Water Sports Galary.",
    description: "Here we save all the good memories of our customers, we are happy to share them with you.",
    ctaText: "Start yours ?",
    ctaLink: "#",
        ...
        <div class="relative isolate px-6 pt-0 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                ...
                <div class="text-center">
                    <h1 class="text-4xl font-bold tracking-tight text-gray-100 sm:text-6xl">${content.title}</h1>
